...
export function Canvas({ isLiveViewer = false }: { isLiveViewer?: boolean }) {
  const { rootList, setSelected, selectedId, canvasStyle, deviceMode, isPreviewMode, setIsPreviewMode, theme } = useBuilderStore();
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          ...(theme ? {
            ...
            '--theme-primary-hover': theme.palette.primaryHover,
            '--theme-primary-fg': theme.palette.primaryFg,
      ...
      >
        ...
        {theme && <link rel="stylesheet" href={theme.googleFontsUrl} />}
        
        {/* Shared Animation Keyframes accessible by Tailwind utilities generated by AI */}
        <style dangerouslySetInnerHTML={{__html: `
          ...
          /* Ensures headings use the theme heading font */
