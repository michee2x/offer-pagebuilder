...
function YouTubeFacade({ videoId, title }: { videoId: string; title: string }) {
  ...
  if (active) {
    return (
      <iframe
        src={`https://www.youtube.com/embed/${videoId}?autoplay=1&mute=0&loop=1&playlist=${videoId}&controls=1&showinfo=0&rel=0&disablekb=1&iv_load_policy=3&modestbranding=1&cc_load_policy=0`}
