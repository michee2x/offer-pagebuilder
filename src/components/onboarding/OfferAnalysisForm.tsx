...
const textareaCls =
  "w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder:text-[#444] focus:outline-none focus:border-white/25 transition-colors resize-none";
      ...
      <div className="relative group/container">
        ...
        <div className="flex items-start justify-between mb-10">
          ...
          <button
            type="button"
            onClick={onFillDemo}
            className="mt-1 px-4 py-2 rounded-lg border border-white/10 bg-[#1a1a1a] text-[11px] font-semibold text-[#777] hover:text-white hover:border-white/20 transition-colors whitespace-nowrap"
          >
            Fill Demo Data
          </button>
        </div>
        ...
        <div className="space-y-5">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedChannels.includes(channel)
                      ...
                      : "bg-[#0a0a0a] border-white/10 text-[#777] hover:border-white/20 hover:text-white"
                  )}
                >
                  {channel}
                </button>
          ...
          <div className="pt-4 pb-8">
            <button
              ...
              className="w-full h-14 rounded-xl bg-brand-yellow text-black font-bold text-[15px] tracking-wide hover:bg-brand-yellow/90 active:scale-[0.99] transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-[0_10px_30px_rgba(245,166,35,0.2)]"
            >
