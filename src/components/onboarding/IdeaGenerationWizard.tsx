...
const labelCls = "block text-base font-medium text-white mb-2";
              ...
              >
                <div>
                  <h2 className="text-[26px] font-bold text-white tracking-tight">
                    Which niche should your offer be in?
                  </h2>
                  <p className="text-[13px] text-white/50 mt-1">
                    Select one or more categories. OfferIQ will generate
                    validated offer ideas specifically for that market.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <label className={labelCls}>
                    Or type your niche directly
                  </label>
                  <Input
                    value={customSkill}
                    onChange={(e) => setCustomSkill(e.target.value)}
                    placeholder="e.g., Personal finance for young Canadian professionals"
                  />
                </div>
                ...
                <div className="pt-4">
                  ...
                  >
                    Define Your Audience <ChevronRight className="h-5 w-5" />
                  </button>
                </div>
              </motion.div>
            )}
            ...
            {currentStep === "B2" && (
              ...
              >
                <div>
                  ...
                  <p className="text-[13px] text-white/50 mt-1">
                    The more specific you are, the sharper your offer
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        value={bCurrency}
                        onChange={(e) =>
                          setBCurrency(e.target.value as CurrencyCode)
                        }
                      >
                        <option value="" disabled className="bg-[#1a1a1a]">
                          Select currency
                        </option>
                        {["USD", "GBP", "EUR", "NGN", "GHS", "KES", "ZAR"].map(
                          (curr) => (
                            <option
                              key={curr}
                              value={curr}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="$10 - $50" className="bg-[#1a1a1a]">
                        $10 - $50 (Low Ticket)
                      </option>
                      <option value="$50 - $200" className="bg-[#1a1a1a]">
                        $50 - $200 (Mid Ticket)
                      </option>
                      <option value="$200 - $1000" className="bg-[#1a1a1a]">
                        $200 - $1000 (High Ticket)
                      </option>
                      <option value="$1000+" className="bg-[#1a1a1a]">
                        $1000+ (Premium)
                      </option>
                    </select>
                    <Chevron />
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full h-14 rounded-full bg-white text-black font-bold text-[15px] tracking-wide hover:bg-zinc-200 active:scale-[0.99] transition-all flex items-center justify-center gap-2 shadow-[0_10px_30px_rgba(0,0,0,0.3)]"
                  >
                    Build Offer Recommendations <Sparkles className="h-5 w-5" />
                  </button>
                </div>
              </motion.div>
            )}
            ...
            {currentStep === "B3" && (
              ...
              >
                <div>
                  ...
                  <p className="text-[13px] text-white/50 mt-1">
                    We&apos;ve architected a few offers based on your skills.
                  </p>
                </div>
                ...
                {isGenerating ? (
                  <div className="py-24 flex flex-col items-center justify-center space-y-5">
                    <Spinner size="lg" />
                    <p className="text-[13px] text-[#555] animate-pulse">
                    ...
                    {generatedIdeas.map((idea, idx) => (
                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-6">
                          <div>
                            <span className="block text-[10px] font-bold uppercase tracking-wider text-white/30 mb-1.5">
                              Market Demand
                            </span>
