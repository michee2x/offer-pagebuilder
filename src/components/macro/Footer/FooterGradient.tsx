...
export function FooterGradient({
  ...
  return (
    <footer
      className={cn(
        "flex flex-col items-center justify-center w-full py-20 bg-linear-to-b from-primary to-primary/80 text-muted-foreground",
        className,
      )}
    ...
    >
      ...
      <p className="mt-4 text-center" style={elementStyles.copyright}>
        {copyrightText}{" "}
        <a
