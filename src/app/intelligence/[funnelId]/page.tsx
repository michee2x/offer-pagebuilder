...
const SECTION_CONFIG: Record<string, ReportSectionConfig> = {
  OFFER_SCORE: {
    ...
    subheader:
      "A comprehensive metric evaluating market viability, audience clarity, and conversion readiness.",
  ...
  SCORE_SUMMARY: {
    ...
    label: "Score Summary",
    subheader:
      "Detailed breakdown of the core metrics evaluating your offer's potential.",
  ...
  REVENUE_MODEL_ARCHITECTURE: {
    ...
    label: "Revenue Model",
    subheader:
      "Architectural blueprint detailing how profitability is structured and compounding avenues.",
  ...
  PAIN_POINT_MAPPING: {
    ...
    label: "Pain Points",
    subheader:
      "Identification of the most critical friction points your audience is experiencing.",
  ...
  STRATEGIC_BONUS_RECOMMENDATIONS: {
    ...
    label: "Bonus Stack",
    subheader:
      "High-perceived-value additions mitigating specific purchase objections.",
  ...
  DESIGN_INTELLIGENCE_RECOMMENDATION: {
    ...
    subheader:
      "Visual principles mapped uniquely to your demographic's trust factors.",
  ...
  FUNNEL_HEALTH_SCORE: {
    ...
    label: "Funnel Health",
    subheader:
      "Diagnostic assessment of architectural integrity, leakage points, and scaling readiness.",
  ...
  PLATFORM_PRIORITY_MATRIX: {
    ...
    subheader:
      "Recommended budget allocation across high-leverage traffic channels.",
  ...
  OFFER_POSITIONING_ANALYSIS: {
    ...
    subheader:
      "Differentiating context framing how your market perceives this offer vs alternatives.",
  ...
  TARGET_PERSONA_INTELLIGENCE: {
    ...
    subheader:
      "Deep psychological profile and contextual awareness of your ideal customer.",
  ...
  CONVERSION_HOOK_LIBRARY: {
    ...
    subheader:
      "Validated, high-impact statements geared to arrest attention instantly.",
  ...
  MESSAGING_ANGLE_MATRIX: {
    ...
    subheader:
      "Combinatorial framework addressing unique desires and specific internal objections.",
  ...
  PRODUCT_CORE_VALUE_PERCEPTION: {
    ...
    subheader:
      "Core transformational mechanics transitioning the prospect from state A to state B.",
  ...
  REAL_WORLD_USE_CASE_SCENARIOS: {
    ...
    label: "Use Cases",
    subheader:
      "Relatable operational implementations proving the offer's impact in context.",
  ...
  MONETIZATION_STRATEGY_NARRATIVE: {
    ...
    subheader:
      "Synthesized executive directive binding acquisition, monetization, and scale.",
...
export default function IntelligencePage({
  ...
  const prevSectionId =
    activeIndex > 0 ? availableSections[activeIndex - 1] : null;
  const nextSectionId =
    activeIndex < availableSections.length - 1
      ? availableSections[activeIndex + 1]
      : null;
  ...
  const activeConfig =
    SECTION_CONFIG[activeSectionId] || SECTION_CONFIG["OFFER_SCORE"];
        ...
        <div className="hidden print:block absolute inset-0 bg-white text-black p-8 z-50 overflow-visible h-auto max-w-none">
          <div className="mb-8 border-b pb-4">
            <h1 className="text-3xl font-bold">
              {funnelName || "Sales Intelligence"}
            </h1>
            <p className="text-gray-500 mt-2">
              Comprehensive Funnel Architecture & Strategic Blueprint
            </p>
          </div>
        ...
        <div className="flex flex-1 overflow-hidden print:hidden">
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        isActive &&
                          "text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70 ml-1",
                      )}
                    >
                      {cfg.label}
                    </span>
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar relative bg-transparent">
            {!formData ? (
                  ...
                  <CardContent className="p-12 text-center space-y-6 relative z-10">
                    ...
                    <div className="space-y-2">
                      <h2 className="text-2xl font-bold text-white tracking-tight">
                        Strategy Blueprint Not Found
                      </h2>
                      <p className="text-[14px] text-white/50 leading-relaxed max-w-sm mx-auto font-light">
                        This campaign does not have any onboarding details yet.
                        Let&apos;s configure your offer parameters to build a
                    ...
                    {phase === "error" ? (
                      <>
                        ...
                        <p className="text-sm text-white/60">
                          {errorMsg ||
                            "An error occurred while generating intelligence."}
                        </p>
                        <Button
                          size="lg"
                          onClick={runAnalysis}
                      ...
                      <>
                        <div className="relative rounded-[2.5rem] bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] hover:border-white/[0.12] transition-all p-8 md:p-12 shadow-2xl">
                          ...
                          <p className="text-sm text-white/60">
                            Automatically synthesizing your intelligence
                            profile...
                          </p>
                          <Button
                            id="auto-run-btn"
                          ...
                          >
                            Generate Report (Hidden Trigger)
                          </Button>
                        </div>
                      </>
                    )}
              ...
              <div
                className={cn(
                  "mx-auto px-6 lg:px-12 py-10 pb-32 relative z-10",
                  ...
                  <div className="mb-10 flex items-baseline justify-between gap-4 border-b border-white/10 pb-6 relative z-10">
                    ...
                    {activeSectionId !==
                      ...
                      <Button
                        ...
                        className="text-white hover:text-cyan-300 hover:bg-white/10 border-white/10 gap-2 shrink-0 rounded-xl transition-colors"
                      >
                      ...
                      >
                        ...
                        <div className="flex flex-col items-start">
                          ...
                          <span className="truncate max-w-[120px] sm:max-w-xs">
                            {SECTION_CONFIG[prevSectionId]?.label}
                          </span>
                        </div>
                      </Button>
                    ) : (
                    ...
                    {nextSectionId ? (
                      ...
                      >
                        <div className="flex flex-col items-end">
                          ...
                          <span className="truncate max-w-[120px] sm:max-w-xs">
                            {SECTION_CONFIG[nextSectionId]?.label}
                          </span>
                        </div>
