                      ...
                      <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] hover:border-white/[0.12] rounded-2xl p-5 transition-all">
                            <h4 className="text-xs font-bold text-brand-yellow uppercase tracking-widest mb-2">
                              Platform Selection Rationale
                            </h4>
                            <p className="text-xs text-muted-foreground leading-relaxed">
                              Calibrated based on primary demographics, price
                              elasticity, and specific outcomes outlined in Call
                              1. Designed to produce the first cash-flow event
                              in the shortest possible validation window.
                            </p>
                          </div>
                          <div className="bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] hover:border-white/[0.12] rounded-2xl p-5 transition-all">
                            <h4 className="text-xs font-bold text-brand-yellow uppercase tracking-widest mb-2">
                            ...
                            <p className="text-xs text-muted-foreground leading-relaxed">
                              Identifies specific saturation flags, ad frequency
                              thresholds, and pixel capture misalignments that
                              threaten initial scaling viability.
                            </p>
                          </div>
                        </div>
                      </div>
